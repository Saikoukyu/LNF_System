        ...
        <section class="content">
            ...
            <section class="profile-section">
                <div class="profile-info">
                    <img src="assets/NU dp.jpg" alt="NU Dasmariñas Logo" class="profile-image">
                ...
                <div class="menu-items">
                    <div class="menu-item">
                        <h3>REPORTS</h3>
                        <img src="assets/check.png" alt="Reports Icon">
                        <button class="edit-btn" onclick="navigateTo('REPORT EDITING.html')">EDIT</button>
                    </div>
                    <div class="menu-item">
                        <h3>ITEMS</h3>
                        <img src="assets/item.png" alt="Items Icon">
                        <button class="edit-btn" onclick="navigateTo('ITEMS EDITING.html')">EDIT</button>
                    </div>
                    <div class="menu-item">
                        <h3>FORM</h3>
                        <img src="assets/form.png" alt="Form Icon">
                        <button class="edit-btn" onclick="navigateTo('FORM EDITING.html')">EDIT</button>
                    </div>
                </div>
            </section>
        </section>
